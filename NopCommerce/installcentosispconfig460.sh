#---------------------------------------------------------------------
# installcentosispconfig460.sh
#
# NopCommerce system installer
#
# Script: installcentosispconfig460.sh
# Version: 3.1.0
...
## Create the /etc/systemd/system/nopCommerce460.service file with the following contents:
...
ExecStart=$dotnet /var/www/$website/web/Nop.Web.dll
Restart=always
...
autostart=true
autorestart=true
stderr_logfile=/var/log/nop/$website-nopCommerce460.err.log
stdout_logfile=/var/log/nop/$website-nopCommerce460.out.log
environment=Hosting__Environment=Production,HOME=/var/www/$website/web
stopsignal=INT
user=root
EOF
