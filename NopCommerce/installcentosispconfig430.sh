...
#
# Script: installcentosispconfig430.sh
# Version: 3.1.0
...
RestartSec=10
KillSignal=SIGINT
SyslogIdentifier=nopCommerce430-$website
User=root
...
[program:$website-nopCommerce430]
...
autostart=true
autorestart=true
stderr_logfile=/var/log/nop/$website-nopCommerce430.err.log
stdout_logfile=/var/log/nop/$website-nopCommerce430.out.log
